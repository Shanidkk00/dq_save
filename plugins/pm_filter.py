...
async def auto_filter(client, msg, spoll=False):
    ...
    if imdb:
        ...
        cap = f"<b>🎪 ᴛɪᴛɪʟᴇ {search}\n\n┏ 🤴 ᴀsᴋᴇᴅ ʙʏ : [{query.message.reply_to_message.from_user.first_name}](tg://need_update_for_some_feature)\n┣ ⚡ ᴘᴏᴡᴇʀᴇᴅ ʙʏ : [ʜᴇɪsᴇɴʙᴇʀɢ](https://t.me/GxHeisenBot)\n┗ 🍁 ᴄʜᴀɴɴᴇʟ : [ᴍᴏᴠɪᴇsᴄʟᴜʙ+](https://t.me/MoviesClubPlus)\n\nᴀꜰᴛᴇʀ 30 ᴍɪɴᴜᴛᴇꜱ ᴛʜɪꜱ ᴍᴇꜱꜱᴀɢᴇ ᴡɪʟʟ ʙᴇ ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇᴅ\n\n★ <i>ᴘᴏᴡᴇʀᴇᴅ ʙʏ  ᴄɪɴᴇᴍᴀʙʀᴀɴᴛʜᴇɴ</i></b>"
    if imdb and imdb.get('poster'):
        try:
            ...
            logger.exception(e)
            await message.reply_text(photo='https://telegra.ph/file/422d0537fd1e0e9336c55.jpg',caption=cap, reply_markup=InlineKeyboardMarkup(btn))
    else:
        await message.reply_text(photo='https://telegra.ph/file/422d0537fd1e0e9336c55.jpg',caption=cap, reply_markup=InlineKeyboardMarkup(btn))
    if spoll:
